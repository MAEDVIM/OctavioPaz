	...
	<div class="row" style="margin-bottom: 10px;">
		...
		<?php
              if($buscarUsuario->num_rows() > 0){
                  foreach($buscarUsuario->result() as $row){?>
			<tr>
			...
			<td><input type="button" class="btn btn-danger" onClick="EliminarUsuario(<?php echo $row->eCodUsuario; ?>)" value="Eliminar Mensaje"></td>
			</tr>
			<?php }
              }else{?>
                  <td colspan="8"></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		<a type="button" href="<?php echo base_url()?>Admin_Panel/ConsultarUsuario" class="btn btn-danger">Eliminar Filtros</a>
